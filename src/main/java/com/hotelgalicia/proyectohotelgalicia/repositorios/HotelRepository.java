...
public interface HotelRepository extends JpaRepository<Hotel, Long> {
        ...
        @Query("SELECT DISTINCT h FROM Hotel h LEFT JOIN FETCH h.valoracion " +
                        ...
                        "AND h.estado = :estado")
        Page<Hotel> findByNombreContainingIgnoreCaseAndMunicipioAndDireccionContainingIgnoreCaseAndEstado(
        ...
        @Query("SELECT DISTINCT h FROM Hotel h LEFT JOIN FETCH h.valoracion " +
                        ...
                        "AND UPPER(h.direccion) LIKE UPPER(CONCAT('%', :direccion, '%')) " +
                        "AND h.estado = :estado")
        Page<Hotel> findByNombreContainingIgnoreCaseAndDireccionContainingIgnoreCaseAndEstado(
                        @Param("nombre") String nombre,
                        @Param("direccion") String direccion,
                        @Param("estado") boolean estado,
                        Pageable pageable);
        ...
        @Query("SELECT DISTINCT h FROM Hotel h LEFT JOIN FETCH h.valoracion " +
                        ...
                        "AND h.municipio = :municipio " +
                        "AND UPPER(h.direccion) LIKE UPPER(CONCAT('%', :direccion, '%'))")
        Page<Hotel> findByNombreContainingIgnoreCaseAndMunicipioAndDireccionContainingIgnoreCase(
                        @Param("nombre") String nombre,
                        @Param("municipio") Municipios municipio,
                        @Param("direccion") String direccion,
                        Pageable pageable);
        ...
        @Query("SELECT DISTINCT h FROM Hotel h LEFT JOIN FETCH h.valoracion " +
                        "WHERE UPPER(h.nombre) LIKE UPPER(CONCAT('%', :nombre, '%')) " +
                        "AND UPPER(h.direccion) LIKE UPPER(CONCAT('%', :direccion, '%'))")
        Page<Hotel> findByNombreContainingIgnoreCaseAndDireccionContainingIgnoreCase(
                        @Param("nombre") String nombre,
                        @Param("direccion") String direccion,
                        Pageable pageable);
