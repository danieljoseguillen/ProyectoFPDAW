...
public class DatosIniciales {
        ...
        //                                 new Valoracion(hoteles.get(0), clientes.get(0),
        //                                                 LocalDate.now().minusDays(29), 9,
        //                                                 "Volvería sin dudarlo."),
        //                                 new Valoracion(hoteles.get(0), clientes.get(2),
        //                                                 LocalDate.now().minusMonths(2).minusDays(7), 6,
        //                                                 "Algunos ruidos de la carretera."),
        //                                 new Valoracion(hoteles.get(0), clientes.get(3),
        //                                                 LocalDate.now().minusDays(45), 8,
        //                                                 "Buena atención y desayuno incluido."),
        //                                 new Valoracion(hoteles.get(0), clientes.get(4),
        //                                                 LocalDate.now().minusDays(72), 7,
        //                                                 "Habitación amplia pero el baño pequeño."),
        //                                 // Media: 7.5
        ...
        //                                 new Valoracion(hoteles.get(7), clientes.get(9),
        //                                                 LocalDate.now().minusDays(56), 9,
        //                                                 "Excelente para negocios."),
        //                                 new Valoracion(hoteles.get(7), clientes.get(0),
        //                                                 LocalDate.now().minusMonths(3).minusDays(15), 10,
        //                                                 "Wifi ultra rápido en todo."),
        //                                 new Valoracion(hoteles.get(7), clientes.get(1),
        //                                                 LocalDate.now().minusDays(24), 9,
        //                                                 "Sala de reuniones de primera calidad."),
        //                                 // Media: 8.6
        ...
        //                                 new Valoracion(hoteles.get(8), clientes.get(4),
        //                                                 LocalDate.now().minusDays(20), 7,
        //                                                 "Sostenibilidad palpable en cada detalle."),
        //                                 // Media: 7.0
        ...
        //                                 new Valoracion(hoteles.get(10), clientes.get(2),
        //                                                 LocalDate.now().minusDays(34), 8,
        //                                                 "Lugar ideal para reflexionar durante viaje.")
        //                 // Media: 7.5
        //                 );
